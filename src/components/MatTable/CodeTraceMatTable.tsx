...
import CodeTraceStyle, { MatTableStyle } from '../../variables/styles/CodeTraceMatTableStyle';
...
class CodeTraceMatTable extends React.Component<MatTableProps & MatTableStyle, {}> {
...
export default withStyles(CodeTraceStyle)<MatTableProps>(CodeTraceMatTable);